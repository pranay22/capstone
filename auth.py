...
Variables for executing the app locally
    AUTH0_DOMAIN = 'dev-3ncdr6eo.eu.auth0.com'
    ALGORITHMS = 'RS256'
...
'''
# source: My own work from full stack coffee shop project
# https://github.com/pranay22/Coffee-shop-fullstack-nanodegree/blob/main/backend/src/auth/auth.py
